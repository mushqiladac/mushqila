"""
Production Settings for Mushqila Travel Management System
Import this in production: DJANGO_SETTINGS_MODULE=config.settings_production
"""
...
CORS_ALLOWED_ORIGINS = config(
    ...
    default='https://mushqila.com,https://www.mushqila.com'
).split(',')
...
EMAIL_HOST_PASSWORD = config('EMAIL_HOST_PASSWORD', default='')
DEFAULT_FROM_EMAIL = config('DEFAULT_FROM_EMAIL', default='noreply@mushqila.com')
SERVER_EMAIL = config('SERVER_EMAIL', default='server@mushqila.com')
...
# Admin Configuration
ADMINS = [
    ('Admin', config('ADMIN_EMAIL', default='admin@mushqila.com')),
]
MANAGERS = ADMINS
...
if config('USE_CORS', default=False, cast=bool):
