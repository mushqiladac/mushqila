...
web_patterns = [
    ...
    # path('search/low-fare/', search_views.LowFareSearchView.as_view(), name='low_fare_search'),  # Not implemented
    # path('search/schedule/', search_views.ScheduleSearchView.as_view(), name='schedule_search'),  # Not implemented
    path('search/multi-city/', search_views.MultiCitySearchView.as_view(), name='multi_city_search'),
    path('search/flexible-dates/', search_views.FlexibleSearchView.as_view(), name='flexible_dates'),
    # path('search/advanced/', search_views.AdvancedSearchView.as_view(), name='advanced_search'),  # Not implemented
    # path('search/history/', search_views.SearchHistoryView.as_view(), name='search_history'),  # Not implemented
    # path('search/saved/', search_views.SavedSearchesView.as_view(), name='saved_searches'),  # Not implemented
    ...
    # path('booking/<uuid:booking_id>/seats/', booking_views.SeatSelectionView.as_view(), name='seat_selection'),  # Not implemented
    # path('booking/<uuid:booking_id>/ancillaries/', booking_views.AncillaryServicesView.as_view(), name='ancillary_services'),  # Not implemented
    ...
    path('booking/<uuid:booking_id>/update/', booking_management.BookingModificationView.as_view(), name='booking_update'),
    path('booking/<uuid:booking_id>/cancel/', booking_management.CancellationRequestView.as_view(), name='booking_cancel'),
    # path('booking/<uuid:booking_id>/void/', booking_management.BookingVoidView.as_view(), name='booking_void'),  # Not implemented
    # path('booking/<uuid:booking_id>/reissue/', booking_management.BookingReissueView.as_view(), name='booking_reissue'),  # Not implemented

    # PNR Management - Not implemented
    ...
    # path('emd/create/', ticketing_views.EMDCreateView.as_view(), name='emd_create'),  # Not implemented
    # path('emd/<uuid:emd_id>/void/', ticketing_views.EMDVoidView.as_view(), name='emd_void'),  # Not implemented
...
# API URLs (for B2B API integration) - Most not implemented yet
api_patterns = [
    # ==============================================
    # FLIGHT SEARCH API
    # ==============================================
    ...
    # UTILITY API
    # ==============================================
    path('api/airports/', api_views.AirportListAPI.as_view(), name='api_airports'),
    path('api/airlines/', api_views.AirlineListAPI.as_view(), name='api_airlines'),
